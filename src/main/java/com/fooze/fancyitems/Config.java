...
public class Config {
    ...
    static {
        ...
        STARBURST_EFFECT_ALLOW_COMMON = BUILDER.define("starburstEffectAllowCommon", false);
        ...
        STARBURST_INTENSITY = BUILDER.defineInRange("starburstIntensity", 1.0D, 0.1D, 1.0D);
        STARBURST_LENGTH_VARIATION = BUILDER.defineInRange("starburstLengthVariation", 0.1D, 0.01D, 1.0D);
        STARBURST_LENGTH_VARIATION_COUNT = BUILDER.defineInRange("starburstLengthVariationCount", 3, 1, 18);
        STARBURST_WIDTH_VARIATION = BUILDER.defineInRange("starburstWidthVariation", 0.05D, 0.01D, 0.5D);
        STARBURST_WIDTH_VARIATION_COUNT = BUILDER.defineInRange("starburstWidthVariationCount", 2, 1, 18);
        ...
        BEAM_EFFECT_ALLOW_COMMON = BUILDER.define("beamEffectAllowCommon", false);
        ...
        SOUND_RANGE = BUILDER.defineInRange("soundRange", 16.0D, 1.0D, 64.0D);
    ...
    public static final ModConfigSpec.BooleanValue STARBURST_EFFECT_ALLOW_COMMON;
    ...
    public static final ModConfigSpec.DoubleValue STARBURST_INTENSITY;
    ...
    public static final ModConfigSpec.BooleanValue BEAM_EFFECT_ALLOW_COMMON;
    ...
    public static final ModConfigSpec.DoubleValue SOUND_RANGE;
